...
$html = file_get_html('http://sretenie.com/book/index.php?count_zap=20&AJAX=1&PAGEN_1=3&SECTION_ID=335');

// Количество страниц каталога

$element=$html->find('.pagination_1 li', -1);
$col=$element->children(0)->plaintext;

/*
$file = 'sretenie_com.csv';
